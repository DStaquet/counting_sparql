...
CREATE TEMP TABLE delta_Minus_5001696111420667855_schema_5974201903695169563_temp_1 AS
SELECT (CASE
...
CREATE TEMP TABLE delta_Minus_5001696111420667855_schema_5974201903695169563_2 AS
SELECT s1.x AS x,
       s1.k_count AS k_count
FROM nu_Union_1443468051870521748 AS s1
...
SELECT (CASE
       ...
       (CASE
            ...
            ELSE R1.k_count + R2.k_count
        END) AS k_count
FROM delta_Minus_5001696111420667855_schema_5974201903695169563_temp_1 AS R1
FULL OUTER JOIN delta_Minus_5001696111420667855_schema_5974201903695169563_2 AS R2 ON R1.x = R2.x
