CREATE TABLE delta_prep_Minus_5001696111420667855_schema_5974201903695169563 AS
SELECT s1.x AS x,
...
CREATE TABLE delta_prep_Minus_5001696111420667855_schema_6925710393041315400 AS
SELECT s1.y AS y,
       s1.k_count AS k_count
...
INSERT INTO delta_prep_Minus_5001696111420667855_schema_5974201903695169563
SELECT *
...
INSERT INTO delta_prep_Minus_5001696111420667855_schema_6925710393041315400
SELECT *
FROM nu_Union_1443468051870521748 AS s1
JOIN delta_Union_6981146949604561737 AS s2 ON s1.x = s2.x
WHERE EXISTS (
...
FROM delta_prep_Minus_5001696111420667855 AS r1
GROUP BY r1.x;
