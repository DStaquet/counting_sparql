CREATE TEMP TABLE delta_Minus_9178504235855424463_0 AS
SELECT s1.x AS x,
...
CREATE TEMP TABLE delta_Minus_9178504235855424463_1 AS
SELECT s1.x AS x,
       s1.k_count AS k_count
...
CREATE TEMP TABLE delta_Minus_9178504235855424463_temp_1 AS
SELECT (CASE
       ...
       (CASE
        ...
        END) AS k_count
FROM delta_Minus_9178504235855424463_0 AS R1
FULL OUTER JOIN delta_Minus_9178504235855424463_1 AS R2 ON R1.x = R2.x;

CREATE TEMP TABLE delta_Minus_9178504235855424463_2 AS
SELECT s1.x AS x,
       s1.k_count AS k_count
FROM nu_BGP_6412654939285419064 AS s1
...
SELECT (CASE
       ...
       (CASE
            ...
            ELSE R1.k_count + R2.k_count
        END) AS k_count
FROM delta_Minus_9178504235855424463_temp_1 AS R1
FULL OUTER JOIN delta_Minus_9178504235855424463_2 AS R2 ON R1.x = R2.x
