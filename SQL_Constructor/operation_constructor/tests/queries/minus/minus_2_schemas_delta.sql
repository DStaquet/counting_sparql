CREATE TEMP TABLE prep_delta_Minus_5787900088682136291 AS
SELECT s1.x AS x,
...
INSERT INTO prep_delta_Minus_5787900088682136291
SELECT *
...
FROM prep_delta_Minus_5787900088682136291 AS r1
GROUP BY r1.x;