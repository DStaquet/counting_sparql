CREATE TEMP TABLE delta_Minus_5016477813953594459_0 AS
SELECT s1.x AS x,
...
CREATE TEMP TABLE delta_Minus_5016477813953594459_1 AS
SELECT s1.x AS x,
       s1.k_count AS k_count
...
SELECT (CASE
       ...
       (CASE
        ...
        END) AS k_count
FROM delta_Minus_5016477813953594459_0 AS R1
FULL OUTER JOIN delta_Minus_5016477813953594459_1 AS R2 ON R1.x = R2.x
