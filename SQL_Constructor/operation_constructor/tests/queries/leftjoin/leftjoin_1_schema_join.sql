CREATE TEMP TABLE delta_LeftJoin_5062614984795814045_0 AS
SELECT r1.x AS x,
       r2.y AS y,
...
SELECT (CASE
       ...
       (CASE
        ...
        END) AS k_count
FROM delta_LeftJoin_5062614984795814045_0 AS R1
FULL OUTER JOIN delta_LeftJoin_5062614984795814045_1 AS R2 ON R1.y = R2.y
AND R1.x = R2.x;
