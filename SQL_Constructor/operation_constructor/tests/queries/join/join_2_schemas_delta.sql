CREATE TEMP TABLE prep_delta_Join_2077603546748115218 AS
SELECT r1.w AS w,
       r2.x AS x,
       r1.y AS y,
...
INSERT INTO prep_delta_Join_2077603546748115218 (w, x, y, k_count)
SELECT r1.w AS w,
       r2.x AS x,
       r1.y AS y,
       r1.k_count * r2.k_count AS k_count
...
CREATE TABLE delta_Join_2077603546748115218 AS
SELECT r1.w,
       r1.x,
       r1.y,
       SUM(r1.k_count) AS k_count
FROM prep_delta_Join_2077603546748115218 AS r1
GROUP BY r1.w,
         r1.x,
         r1.y
