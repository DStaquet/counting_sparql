...
INSERT INTO prep_delta_Join_6729856109576745271_schema_57734893926349734
SELECT r1.w AS w,
       r1.y AS y,
       r2.x AS x,
       r1.k_count * r2.k_count AS k_count
FROM nu_BGP_5127379026335911785 AS r1,
     delta_Union_1860242193064701327_schema_5536938746033674259 AS r2 ON r1.y = r2.y;
...
INSERT INTO prep_delta_Join_6729856109576745271_schema_3615708767843743351
SELECT r1.w AS w,
       r1.y AS y, , r1.k_count * r2.k_count AS k_count
FROM nu_BGP_5127379026335911785 AS r1,
     delta_Union_1860242193064701327_schema_3615708767843743351 AS r2 ON r1.w = r2.w
AND r1.y = r2.y;
