CREATE TEMP TABLE delta_BGP_5122102145835688356_0 AS
SELECT G3.o AS w,
       G2.s AS x,
       G1.s AS y,
       G3.s AS z,
...
CREATE TEMP TABLE delta_BGP_5122102145835688356_1 AS
SELECT G3.o AS w,
       G2.s AS x,
       G1.s AS y,
       G3.s AS z,
...
CREATE TEMP TABLE delta_BGP_5122102145835688356_temp_1 AS
SELECT (CASE
       ...
       (CASE
        ...
        END) AS k_count
FROM delta_BGP_5122102145835688356_0 AS R1
FULL OUTER JOIN delta_BGP_5122102145835688356_1 AS R2 ON R1.y = R2.y
AND R1.z = R2.z
AND R1.w = R2.w
AND R1.x = R2.x;

CREATE TEMP TABLE delta_BGP_5122102145835688356_2 AS
SELECT G3.o AS w,
       G2.s AS x,
       G1.s AS y,
       G3.s AS z,
...
SELECT (CASE
       ...
       (CASE
            ...
            ELSE R1.k_count + R2.k_count
        END) AS k_count
FROM delta_BGP_5122102145835688356_temp_1 AS R1
