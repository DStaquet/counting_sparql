CREATE TEMP TABLE delta_BGP_7479567498023511432_0 AS
SELECT G1.s AS x,
       G2.s AS y,
       G2.o AS z,
       G1.k_count
...
CREATE TEMP TABLE delta_BGP_7479567498023511432_1 AS
SELECT G1.s AS x,
       G2.s AS y,
       G2.o AS z,
       G2.k_count
...
SELECT (CASE
       ...
       (CASE
        ...
        END) AS k_count
FROM delta_BGP_7479567498023511432_0 AS R1
FULL OUTER JOIN delta_BGP_7479567498023511432_1 AS R2 ON R1.y = R2.y
AND R1.x = R2.x
AND R1.z = R2.z
