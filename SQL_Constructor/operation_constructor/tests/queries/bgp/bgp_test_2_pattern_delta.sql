CREATE TEMP TABLE prep_delta_BGP_2691716057464995186 AS
SELECT G1.s AS x,
       G2.s AS y,
       G2.o AS z,
       G1.k_count
...
INSERT INTO prep_delta_BGP_2691716057464995186 (x, y, z, k_count)
SELECT G1.s AS x,
       G2.s AS y,
       G2.o AS z,
       G2.k_count
...
FROM prep_delta_BGP_2691716057464995186 AS r1
GROUP BY r1.x,
         r1.y,
         r1.z
