...
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_1000.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_1000_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_1000_50.csv -icsv -ocsv measurements/output.csv -s -r 50 > measurements/tri_hop_1000_50_optional.txt

# Run the benchmark for the tri_hop query with 100 nodes and 50 delta values
echo 'Running with n=1000, p=100, k=50'
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_100.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_100_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_100_50.csv -ocsv measurements/output.csv -r 5 > measurements/tri_hop_100_50_optional.txt

# Run the benchmark for the tri_hop query with 50 nodes and 50 delta values
echo 'Running with n=1000, p=50, k=50'
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_50.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_50_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_50_50.csv -ocsv measurements/output.csv -r 5 > measurements/tri_hop_50_50_optional.txt

# Run the benchmark for the tri_hop query with 32 nodes 50 delta values
echo 'Running with n=1000, p=35, k=50'
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_35.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_35_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_35_50.csv -ocsv measurements/output.csv -r 5 > measurements/tri_hop_35_50_optional.txt

echo 'Running with n=1000, p=30, k=50'
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_30.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_30_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_30_50.csv -ocsv measurements/output.csv -r 5 -db database/tri_hop_optional.db > measurements/tri_hop_30_50_optional.txt

echo 'Running with n=1000, p=25, k=50'
python3 main.py Queries/hops/tri_hop_optional.sparql temp_tests -d data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_25.csv -dl data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_delta_25_50.csv -nf data/exemplary_data/hop_graphs_n_1000/graph_chain_tri_hop_nu_25_50.csv -ocsv measurements/output.csv -r 3 -db database/tri_hop_optional.db > measurements/tri_hop_25_50_optional.txt