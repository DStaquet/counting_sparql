echo "Running script with 1000 products, 50 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 1000 products, 100 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 1000 products, 1000 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 5000 products, 50 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 5000 products, 100 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 5000 products, 1000 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 10000 products, 50 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 10000 products, 100 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 20000 products, 50 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 20000 products, 100 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 50000 products, 50 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
...
echo "\n\nRunning script with 50000 products, 100 inputs per product, 1000 products to delta, 10 samples per delta, 10 runs"
