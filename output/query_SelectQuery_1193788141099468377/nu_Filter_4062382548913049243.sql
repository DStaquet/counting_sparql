INSERT INTO nu_Filter_4062382548913049243 (label, p1, product, propertyTextual, k_count)
SELECT (CASE
...
FULL OUTER JOIN delta_Filter_4062382548913049243 AS r2 ON r1.label = r2.label
AND r1.p1 = r2.p1
