INSERT INTO nu_BGP_2732790592149769836 (label, p1, product, propertyTextual, k_count)
SELECT (CASE
...
FROM BGP_2732790592149769836 AS r1
FULL OUTER JOIN delta_BGP_2732790592149769836 AS r2 ON r1.label = r2.label
AND r1.p1 = r2.p1
