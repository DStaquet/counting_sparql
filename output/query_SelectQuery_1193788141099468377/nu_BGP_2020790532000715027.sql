INSERT INTO nu_BGP_2020790532000715027 (label, p2, product, propertyTextual, k_count)
SELECT (CASE
...
FROM BGP_2020790532000715027 AS r1
FULL OUTER JOIN delta_BGP_2020790532000715027 AS r2 ON r1.label = r2.label
AND r1.p2 = r2.p2
