INSERT INTO nu_SelectQuery_5548899459227439178 (label, product, value1, k_count)
SELECT (CASE
...
FROM SelectQuery_5548899459227439178 AS r1
FULL OUTER JOIN delta_SelectQuery_5548899459227439178 AS r2 ON r1.label = r2.label
