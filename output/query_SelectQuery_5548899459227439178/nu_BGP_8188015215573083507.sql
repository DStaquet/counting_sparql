INSERT INTO nu_BGP_8188015215573083507 (label, product, value1, k_count)
SELECT (CASE
...
FROM BGP_8188015215573083507 AS r1
FULL OUTER JOIN delta_BGP_8188015215573083507 AS r2 ON r1.label = r2.label
