INSERT INTO delta_BGP_8188015215573083507 (label, product, value1, k_count)
...
WHERE G1.p = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'
  ...
  AND G2.o = 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/ProductFeature139'
  AND G1.s = G3.s
  AND G3.p = 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/productFeature'
  AND G3.o = 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/ProductFeature712'
  AND G1.s = G4.s
