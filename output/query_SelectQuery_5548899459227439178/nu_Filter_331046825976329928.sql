INSERT INTO nu_Filter_331046825976329928 (label, product, value1, k_count)
SELECT (CASE
...
FROM Filter_331046825976329928 AS r1
FULL OUTER JOIN delta_Filter_331046825976329928 AS r2 ON r1.label = r2.label
