INSERT INTO nu_Filter_2470482819316668795 (label, product, value1, k_count)
SELECT (CASE
...
FROM Filter_2470482819316668795 AS r1
FULL OUTER JOIN delta_Filter_2470482819316668795 AS r2 ON r1.label = r2.label
