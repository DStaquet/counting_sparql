INSERT INTO nu_SelectQuery_1187981548447114025 (label, product, value1, k_count)
SELECT (CASE
...
FROM SelectQuery_1187981548447114025 AS r1
FULL OUTER JOIN delta_SelectQuery_1187981548447114025 AS r2 ON r1.label = r2.label
