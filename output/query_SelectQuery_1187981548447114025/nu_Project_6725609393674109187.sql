INSERT INTO nu_Project_6725609393674109187 (label, product, k_count)
SELECT (CASE
...
FROM Project_6725609393674109187 AS r1
FULL OUTER JOIN delta_Project_6725609393674109187 AS r2 ON r1.label = r2.label
