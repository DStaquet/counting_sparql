INSERT INTO nu_Filter_7141111257548129695 (label, p1, p3, product, k_count)
SELECT (CASE
...
FROM Filter_7141111257548129695 AS r1
FULL OUTER JOIN delta_Filter_7141111257548129695 AS r2 ON r1.label = r2.label
AND r1.p1 = r2.p1
AND r1.p3 = r2.p3
