INSERT INTO nu_BGP_4245425749932949804 (label, p1, p3, product, k_count)
SELECT (CASE
...
FROM BGP_4245425749932949804 AS r1
FULL OUTER JOIN delta_BGP_4245425749932949804 AS r2 ON r1.label = r2.label
AND r1.p1 = r2.p1
AND r1.p3 = r2.p3
