CREATE TABLE delta_Union_5968519747945714539schema_5536938746033674259 (x, y, k_count INT) AS
SELECT (CASE
...
CREATE TABLE delta_Union_5968519747945714539schema_7808164217916843974 (y, z, k_count INT) AS
SELECT (CASE
            WHEN r1.y IS NOT NULL THEN r1.y
            ELSE r2.y
        END) AS y,
